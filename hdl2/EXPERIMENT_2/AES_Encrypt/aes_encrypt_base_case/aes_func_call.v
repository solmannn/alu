...
(* CORE_GENERATION_INFO="aes_func_call,hls_ip_2018_3,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12tcsg325-1q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.334000,HLS_SYN_LAT=661,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=648,HLS_SYN_LUT=3115,HLS_VERSION=2018_3}" *)
...
MixColumn_AddRoundKe grp_MixColumn_AddRoundKe_fu_122(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
