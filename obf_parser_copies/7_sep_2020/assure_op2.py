...
def create_dummy_state(dummy_state_no,input_module,res,all_reg,input_list,input_list_length,all_operations):
    no_of_operations=random.randint(0,4)
    i=0
    ...
    while i<no_of_operations:
        ...
        if mul_chain == 1:
            ...
            if flag==0:
                random_no=random.randint(0,len(all_operations)-1)
                ops=all_operations[random_no]
...
def add_spurious_transition(input_module,it,all_reg,list_working_key,user_key,res,cfg,input_list,input_list_length,all_operations):
    for it in input_module.items:
        if type(it) is vast.Always:
            if type(it.statement.statements[0]) is vast.IfStatement:
...
def dummy_state_function(input_module,res,all_reg,no_of_states,input_list,input_list_length,all_operations):
    #print(type(input_list))
    ...
    while i<add_dummy_no:
        #iter=i+1
        create_dummy_state(dummy_state_no,input_module,res,all_reg,input_list,input_list_length,all_operations)
...
def perform_module_obfuscation(original_module, cfg,list_working_key,user_key):
    ...
    if cfg.dummy_states:
        add_dummy_no=dummy_state_function(input_module,res,all_reg,no_of_states,input_list,input_list_length,all_operations)
    ...
    '''
    if cfg.spurious_ops:
        add_spurious_transition(input_module,it,all_reg,list_working_key,user_key,res,cfg,input_list,input_list_length,all_operations)
    '''
